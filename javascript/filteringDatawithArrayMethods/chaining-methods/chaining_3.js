...
const totalAmountIntegers = integers.sort((a, b) =>  a - b ).filter((num) => num < 19).map((amount) => amount * 1.5 - 1).reduce((total, amount) => total + amount)

const integerElement = document.getElementById("domContainer")

integerElement.innerHTML += `
<section>
<p>Total: ${totalAmountIntegers}</p>
</section>
`
